...
export default function Home() {
  ...
  const todayRoutine = mockTodayRoutine
    ...
    <div className="flex flex-col gap-8 min-h-screen px-6 pt-8 pb-32">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-on-secondary-container text-sm">6 exercises · ~55 min</p>
        </div>
        <div className="w-full h-0.5 bg-on-secondary-container rounded-full overflow-hidden">
          <div className="h-full bg-accent w-0" />
        </div>
        <button className="w-full bg-accent hover:bg-accent-hover text-accent-on
        ...
        <div className="flex flex-col gap-2">
          {recentPrs.map((pr, idx) => (
            ...
            >
              ...
              <span className="bg-amber text-amber-on text-xs font-bold
